...
\end{equation*}
The idea is to construct a Monte-Carlo approximation of the rightmost integral in the preceding expression.
To do this, we need to employ what is called a ``reduced run.''
