...
Note that we can simultaneously calculate all of the arguments for the normal density as $\widetilde{Y} - \widetilde{X} \Gamma^*$ using the notation defined above in the description of efficient calculations for $R_T$.
